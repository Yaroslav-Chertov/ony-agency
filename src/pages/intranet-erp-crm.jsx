...
export default async ({ data }) => {
    const metaTags = {
        description: 'Разработка интранет-порталов, CRM и ERP-систем для бизнеса. Создаем эффективные решения для повышения производительности и оптимизации работы компании!',
        ogDescription: 'Разработка интранет-порталов, CRM и ERP-систем для бизнеса. Создаем эффективные решения для повышения производительности и оптимизации работы компании!',
    }

    const common = {
        title: 'Делаем гибкие системы, которыми удобно пользоваться',
        description: `<p>Поможем автоматизировать ваши процессы и&nbsp;избавиться от&nbsp;хаоса. Углубимся в&nbsp;ваш бизнес, чтобы предлагать рабочие решения. Учтём бюджет и&nbsp;задачи&nbsp;&mdash; предложим готовый вариант или кастомную разработку. Сделаем сложные интерфейсы понятными и&nbsp;стильными. Соберем под проект нужных специалистов и&nbsp;стек технологий. Знаем, что работа не&nbsp;заканчивается после релиза, так что обучим вашу команду, обеспечим поддержку и&nbsp;доработаем продукт под новые задачи.</p>`
    }
    ...
    const process = [
        {
            ...
            num: '05',
            title: 'Проектируем',
            text: 'Утверждаем структуру и рисуем прототипы'
        }, {
            num: '06',
            title: 'Рисуем дизайн',
            ...
            num: '07',
            title: 'Разрабатываем',
            text: 'Используем и настраиваем готовые решения или пишем кастомное решение'
        }, {
            num: '08',
            title: 'Релизим',
            ...
            num: '09',
            title: 'Обучаем',
            text: 'Пишем мануал по работе с продуктом на понятном языке'
        }, {
            num: '10',
            title: 'Поддерживаем',
            text: 'Бережно следим за работой проекта и дополняем функционал'
        }
    ]
    ...
    const technology = [
        {
            ...
            title: 'Backend',
            list: ['Python', 'Laravel', 'Go', 'PHP', 'Django']
        }
    ]
    ...
    const team = [
        {
            ...
            title: 'Разработчики',
            text: 'Отвечают за код, поддержку и обучение'
        }
    ]
    ...
    const cases = [
        {
            ...
            "link": '/work/torgi223',
            "title": 'Торги223',
            "subtitle": 'Айдентика и промосайт',
    ...
    return <Layout title="Разработка интранетов, CRM и ERP-систем" meta={metaTags}>
