...
export default async ({ data }) => {
    const metaTags = {
        description: 'Разработка промо-сайтов и лендингов: создаем эффективные и визуально привлекательные страницы | Чтобы заказать — заполните бриф на сайте',
        ogDescription: 'Разработка промо-сайтов и лендингов: создаем эффективные и визуально привлекательные страницы | Чтобы заказать — заполните бриф на сайте',
    }

    const common = {
        title: 'Делаем уникальные лендинги и промо сайты',
        description: `<p>Поможем эффектно подать и продать ваш продукт целевой аудитории. Сделаем проект, который привлечет внимание и может собрать награды. Опираемся на сильные идеи, но не забываем ваши бизнес-цели. Берём на себя всё: от исследований и подачи до разработки и поддержки. Если сроки сжатые, то соберем сайт на nocode инструментах: Tilda, Readymag, Webflow.</p>`
    }
    ...
    const process = [
        {
            ...
            text: 'Узнаем как он устроен и почему классный'
        }, {
            num: '04',
            title: 'Планируем',
            ...
            num: '07',
            title: 'Разрабатываем',
            text: 'Пишем код или используем nocode инструменты: Tilda, Readymag, Webflow'
        }, {
            num: '08',
            title: 'Релизим',
    ...
    const technology = [
        {
            title: 'Backend',
            list: ['Bitrix', 'Laravel', 'Go', 'PHP', 'Django']
        }, {
            title: 'Frontend',
    ...
    const cases = [
        {
            ...
            "id": '',
            "link": '/work/ostrovok-komandirovki',
            "title": 'Островок Командировки',
            "subtitle": 'Дизайн-концепция сайта',
            "note": 'Командировки без стресса',
            "preview": {
                "video": '',
                "img": {
                    "src": 'https://api.ony.ru/images/uploads/4bff2761f483738f2cf98e0243413b74.png',
                    "alt": ''
                }
            }
        }
    ...
    return <Layout title="Разработка промо-сайтов и лендингов" meta={metaTags}>
