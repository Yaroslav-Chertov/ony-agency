...
export default async ({ data }) => {
    const metaTags = {
        description: 'Создание дизайн-концепции цифрового продукта. Помогаем трансформировать идеи в интуитивно понятные и привлекательные цифровые решения! | Чтобы заказать — заполните бриф на сайте',
        ogDescription: 'Создание дизайн-концепции цифрового продукта. Помогаем трансформировать идеи в интуитивно понятные и привлекательные цифровые решения! | Чтобы заказать — заполните бриф на сайте',
    }

    const common = {
        title: 'Делаем эффектные дизайн-концепции диджитал-продукта',
        description: `<p>Сделаем концепцию, которая будет выделяться. Мы работали с Золотым Яблоком, МТС и Яндексом и знаем как сделать что-то особенное и запоминающееся. А еще знаем, что кроме формы есть и функции. Так что погрузимся в ваши бизнес-задачи и сделаем проект, который будет им соответствовать.</p>`
    }
    ...
    const process = [
        {
            ...
            num: '02',
            title: 'Исследуем',
            text: 'По запросу изучаем рынок, конкурентов'
        }, {
            num: '03',
            title: 'Погружаемся в продукт',
            text: 'Узнаем как он устроен'
        }, {
            num: '04',
            title: 'Планируем',
            ...
            num: '05',
            title: 'Проектируем',
            text: 'Собираем прототип, чтобы понимать архитектуру проекта'
        }, {
            num: '06',
            title: 'Ищем метафоры и стиль',
            text: 'Развиваем фирменный стиль или ищем новый голос'
        }, {
            num: '07',
            title: 'Рисуем концепцию',
            text: 'Рисуем и защищаем дизайн-макеты'
        }
    ]
    ...
    /* const technology = [
        {
            title: 'Backend',
            list: ['Node.js', 'Laravel', 'Go', 'PHP', 'Django']
        }, {
            title: 'Frontend',
            list: ['JavaScript', 'TypeScript', 'React (NEXT)', 'Vue (NUXT)', 'Three.js']
        }, {
            title: 'Nocode',
            list: ['Tilda', 'Readymag', 'Webflow']
        }
    ] */
    ...
    const team = [
        {
            title: 'Аналитик',
            text: 'Изучит ваши процессы, чтобы мы были максимально погружены в бизнес'
        }, {
            title: 'Продакт',
    ...
    const approach = [
        {
            title: 'Готовы разбираться в&nbsp;сложном',
            text: 'Делали перезапуск платформы kia.ru и&nbsp;много екомов'
        }, {
            title: 'Работаем по&nbsp;Agile',
            text: 'Итерациями для гибкости и&nbsp;скорости'
        }, {
            title: 'Всегда на&nbsp;связи',
            text: 'Назначаем установочные встречи, обучаем инструментам, тестируем продукт и&nbsp;делаем выводы вместе'
        }
    ]
    ...
    const cases = [
        {
            ...
            "title": 'Dodo Brands',
            "subtitle": 'Карьерный портал международной франчайзинговой компании',
            "note": 'Прозрачный найм и открытая культура',
            "preview": {
                "video": '',
                "img": {
            ...
            "id": '',
            "link": '/work/mts-brandportal',
            "title": 'МТС Бренд портал',
            "subtitle": 'Собрали всё о брендах экосистемы МТС на одном сайте',
            "note": 'Цифровая экосистема',
            "preview": {
                "video": 'https://ony-ru-media.storage.yandexcloud.net/untitled%20folder%204/untitled%20folder%2018/1.mp4',
                "img": {
                    "src": '',
                    "alt": ''
                }
            ...
            "id": '',
            "link": '/work/liquides-imaginaires',
            "title": 'Liquides Imaginaires',
            "subtitle": 'Сайт французского парфюмерного бренда',
            "note": 'Ключ от воображаемого мира',
            "preview": {
                "video": '',
                "img": {
                    "src": 'https://api.ony.ru/images/uploads/d635044c05ee47213bfc15c981fedd3a.jpg',
                    "alt": ''
                }
            }
        }/*, {
    ...
    return <Layout title="Разработка дизайн-концепции цифрового продукта" meta={metaTags}>
