...
export default async ({ data }) => {
    const metaTags = {
        description: 'Дизайн-поддержка для ваших продуктов. Обеспечим привлекательность и удобство вашего продукта на всех этапах его развития | Чтобы заказать — заполните бриф на сайте',
        ogDescription: 'Дизайн-поддержка для ваших продуктов. Обеспечим привлекательность и удобство вашего продукта на всех этапах его развития | Чтобы заказать — заполните бриф на сайте',
    }

    const common = {
        title: 'Дизайн-поддержка для ваших продуктов',
        description: `<p>Поможем сохранить качество вашего продукта. Знаем, что после запуска есть много работы: шлифовка визуала, задачи из бэклога или подготовка к следующему релизу. Мы готовы погрузиться в легаси продукта и предлагать решения в дизайне в партнерстве с вами.</p>`
    }
    ...
    const process = [
        {
            ...
            num: '03',
            title: 'Планируем',
            text: 'Составляем дорожные карты, Гант и задачи'
        }, {
            num: '04',
            title: 'Проектируем',
            ...
            num: '06',
            title: 'Передаем решение в разработку',
            text: 'Описываем макеты и функционал для вашей команды'
        }, {
            num: '07',
            title: 'Проверяем результат',
            text: 'Наши тестировщики и дизайнеры сверяют точность исполнения'
        }, {
            num: '08',
            title: 'Снова планируем',
            text: 'Сверяемся с дорожными картами и корректируем сроки'
        }
    ]
    ...
    const team = [
        {
            ...
            title: 'Разработчики',
            text: 'По запросу. Смогут внедрить решение в ваш продукт'
        }
    ]
    ...
    const cases = [
        {
            ...
            "link": '/work/kia-ru',
            "title": 'KIA',
            "subtitle": 'Сайт корейского автопроизводителя',
    ...
    return <Layout title="Дизайн-поддержка" meta={metaTags}>
