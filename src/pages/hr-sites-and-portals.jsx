...
export default async ({ data }) => {
    const metaTags = {
        description: 'Разработка сайтов для HR: создание корпоративных порталов, платформ для рекрутинга и внутренней коммуникации | Чтобы заказать — заполните бриф на сайте',
        ogDescription: 'Разработка сайтов для HR: создание корпоративных порталов, платформ для рекрутинга и внутренней коммуникации | Чтобы заказать — заполните бриф на сайте',
    }

    const common = {
        title: 'Делаем HR сайты и порталы для ваших новых талантов',
        description: `<p>Сделаем HR сайт или портал, который покажет ваши ценности и расскажет, почему у вас круто работать. Готовые HR площадки часто тесные — мы кастомизируем всё под вас: добавим лайв-трансляции для вебинаров, презентаций или гибкую админку для настройки. Соберем под проект нужных специалистов и стек технологий. Вы получите стильный и удобный продукт.</p>`
    }
    ...
    const process = [
        {
            ...
            num: '06',
            title: 'Разрабатываем',
            text: 'Пишем код и делаем нужные интеграции'
        }, {
            num: '07',
            title: 'Релизим',
    ...
    const cases = [
        {
            "id": '',
            "link": '/work/raiffeisen-dgtl',
            "title": 'Raiffeisen DGTL',
            "subtitle": 'Карьерный сайт Райффайзен банка',
            "note": 'Свое место',
            "preview": {
    ...
    return <Layout title="Разработка сайтов для HR" meta={metaTags}>
